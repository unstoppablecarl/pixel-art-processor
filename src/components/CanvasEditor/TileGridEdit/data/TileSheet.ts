import { extractPixelData, PixelData, resizeImageData, type SerializedImageData, writeImageData } from 'pixel-data-js'
...
export function makeTileSheet(
  ...
  let pixelData = markRaw(new PixelData(img))
